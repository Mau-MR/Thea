        ...
        <div className="content-div">
          ...
          <TableContainer className={classes.contenedor}>
            <Table className={classes.table} aria-label="customized table">
              <TableHead className={classes.head}>
                <TableRow>
                  <StyledTableCell align="center" className={classes.cabecera}>
                    Fecha
                  </StyledTableCell>
                  <StyledTableCell align="center" className={classes.cabecera}>
                    Cita
          ...
          <div className="PV-inferior">
            ...
            <TextField
              ...
              helperText={
                this.state.Valido ? DescripcionServicio : "Incorrecto"
              }
              onKeyPress={(ev) => {
                if (ev.key === "Enter") {
            ...
            <FormControl>
              <InputLabel
                id="Lashista"
                style={{ marginTop: 11, marginLeft: 8 }}
              >
                Lashista
              </InputLabel>
              <Select
            ...
            <IconButton className={classes.money}>
