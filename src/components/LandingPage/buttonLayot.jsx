    ...
    render() {
        ...
        <div>
            <div className ="buttons-div"> 
                ...
                id = {0} 
                onClick={this.handleClick}>Punto Venta</button>
                ...
                className="window-layout"
                id = {2} 
                onClick={this.handleClick}>Calendario</button>

                <button className="window-layout"
                id = {3} 
                onClick={this.handleClick}>Analisis</button>
            </div>
            <div>
