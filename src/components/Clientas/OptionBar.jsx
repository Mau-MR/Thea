...
export default class OptionBar extends Component {
    ...
    changeColor(id){
        var v = "0";
        if(id==="1"){
            var b1 = document.querySelector("div.buttons-div-clientas button[id='1']");
            this.BI =b1
            b1.style.background = "rgb(213,78,103)";
            b1.style.color ="white";
            v = "1";
        }else if(id==="2"){
            var b2 = document.querySelector("div.buttons-div-clientas button[id='2']");
            this.BI =b2
            b2.style.background = "rgb(213,78,103)";
            b2.style.color ="white";
            v ="2";
        }else if(id==="3"){
            var b3 = document.querySelector("div.buttons-div-clientas button[id='3']");
            this.BI =b3
            b3.style.background = "rgb(213,78,103)";
            b3.style.color ="white";
            v="3";
        }else if(id ==="0"){
            var b0 = document.querySelector("div.buttons-div-clientas button[id='0']");
            this.BI =b0
        ...
        <div className="display-div">
            <div className = "side-bar-clientas">
                <div className ="buttons-div-clientas"> 
                    ...
                    id = {0} 
                    onClick={this.handleClick}>Bitacoras</button>
                
                    <button 
                    className="window-layout-clientas" 
                    id = {1} 
                    onClick={this.handleClick}>Registro</button>

                    <button 
                    className="window-layout-clientas"
                    id = {2} 
                    onClick={this.handleClick}>Citas</button>

                    <button className="window-layout-clientas"
                    id = {3} 
                    onClick={this.handleClick}>Corrección</button>
                </div>
            </div>
            <div className = "content-div-clientas">
